...
#define PERIPH_PM_NEEDS_CORTEXM_COMMON_FALLBACK_REBOOT
/* set_lowest and off from pm_layered */
#else
#define PERIPH_PM_NEEDS_CORTEXM_COMMON_FALLBACK
#define PERIPH_PM_NEEDS_FALLBACK_OFF
#endif
/** @} */
