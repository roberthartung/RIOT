...
#ifdef MODULE_PM_LAYERED
            pm_unblock(PM_SLEEPMODE_INVALID_TIMER0);
#endif
        break;
    #endif
    #ifdef MEGA_TIMER1
...
#ifdef MODULE_PM_LAYERED
            pm_unblock(PM_SLEEPMODE_INVALID_TIMER1);
#endif
        break;
    #endif
    #ifdef MEGA_TIMER1
...
#ifdef MODULE_PM_LAYERED
            pm_unblock(PM_SLEEPMODE_INVALID_TIMER3);
#endif
        break;
    #endif
    #ifdef MEGA_TIMER4
...
#ifdef MODULE_PM_LAYERED
            pm_unblock(PM_SLEEPMODE_INVALID_TIMER4);
#endif
        break;
    #endif
    #ifdef MEGA_TIMER5
...
#ifdef MODULE_PM_LAYERED
            pm_unblock(PM_SLEEPMODE_INVALID_TIMER5);
#endif
        break;
    #endif
    }
...
void timer_poweron(tim_t tim) {
    switch(ctx[tim].num) {
        ...
        case 0 :
#ifdef MODULE_PM_LAYERED
            pm_block(PM_SLEEPMODE_INVALID_TIMER0);
#endif
            power_timer0_enable();
        break;
    #endif
        ...
        case 1 :
#ifdef MODULE_PM_LAYERED
            pm_block(PM_SLEEPMODE_INVALID_TIMER1);
#endif
            power_timer1_enable();
        break;
    #endif
        ...
        case 3 :
#ifdef MODULE_PM_LAYERED
            pm_block(PM_SLEEPMODE_INVALID_TIMER3);
#endif
            power_timer3_enable();
        break;
    #endif
        ...
        case 4 :
#ifdef MODULE_PM_LAYERED
            pm_block(PM_SLEEPMODE_INVALID_TIMER4);
#endif
            power_timer4_enable();
        break;
    #endif
        ...
        case 5 :
#ifdef MODULE_PM_LAYERED
            pm_block(PM_SLEEPMODE_INVALID_TIMER5);
#endif
            power_timer5_enable();
        break;
    #endif
